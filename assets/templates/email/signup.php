                            ...
                            <table bgcolor="#FFFFFF" style="border-radius:6px;" width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td align="center">
                                        <table align="center" width="90%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td align="center" style="font-family: 'Century Gothic', Arial, sans-serif; color:#414a51; font-size:28px;font-weight: bold;">Sign Up Successful</td>
                                            </tr>
                                            <tr>
                                                <td align="center">
                                            ...
                                            <tr>
                                                <td align="center" style="font-family: 'Open sans', Arial, sans-serif; color:#7f8c8d; font-size:14px; line-height: 28px;">
                                                    Welcome <?php echo (isset($_GET['name']) ? $_GET['name'] : ''); ?>, you have successfully signed up an account with EcoSplash. Your account details are shown below.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center">
