...
<body>
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td background="https://www.dropbox.com/s/gdviobzi8aac0pn/forgotpassword.jpg?raw=1" bgcolor="#ececec" style="background-size:cover; background-position:center; background-repeat:no-repeat" valign="top">
                            ...
                            <table bgcolor="#FFFFFF" style="border-radius:6px;" width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td align="center">
                                        <table align="center" width="90%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td align="center" style="font-family: 'Century Gothic', Arial, sans-serif; color:#414a51; font-size:28px;font-weight: bold;">Password Changed Successful</td>
                                            </tr>
                                            <tr>
                                                <td align="center">
                                            ...
                                            <tr>
                                                <td align="center" style="font-family: 'Open sans', Arial, sans-serif; color:#7f8c8d; font-size:14px; line-height: 28px;">
                                                    ...
                                                    <p>
                                                        <u style="font-weight: bold; font-size:18px; color: #212529;">Password</u><br />
                                                        <?php echo (isset($_GET['password']) ? $_GET['password'] : ''); ?>
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
